...
- 'sudo apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv D68FA50FEA312927'  ## this will retrieve the key from website

- Now download required packages by running below command
